                            ...
                            <div class="row flex">
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control" id="kode_faku" name="kode_faku" required>
                                        <?php if($faku) { 
                                            foreach ($faku as $f) { ?>
                                                <option value="<?php echo $f['kode_fakultas']; ?>" <?php if ($mhs['kode_fakultas'] == $f['kode_fakultas']) echo 'selected'; ?>>
                                                    <?php echo $f['nama_fakultas']; ?>
                                                </option>
                                            <?php } 
                                        } else { ?>
                                            <option value="">No fakultas found</option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control" id="kode_jurusan" name="kode_jurusan" required>
                                        <?php if($jurusan) { 
                                            foreach ($jurusan as $j) { ?>
                                                <option value="<?php echo $j['kode_jurusan']; ?>" <?php if ($mhs['kode_jurusan'] == $j['kode_jurusan']) echo 'selected'; ?>>
                                                    <?php echo $j['nama_jurusan']; ?>
                                                </option>
                                            <?php } 
                                        } else { ?>
                                            <option value="">No jurusan found</option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md">
