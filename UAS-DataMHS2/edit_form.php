...
if (isset($_SESSION['user']) && isset($_GET['id_mhs'])) {
    ...
    <div class="container mt-3">
        ...
        <form action="update_mahasiswa.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username_mhs" name="username_mhs" value="<?php echo $mhs['username']; ?>" required>
            </div>
            <div class="form-group">
                <label for="password_mhs">Password:</label>
                <input type="password" class="form-control" id="password_mhs" name="password_mhs" value="<?php echo $mhs['password']; ?>" required>
            </div>
            <div class="form-group">
